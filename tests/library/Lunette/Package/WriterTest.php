 ...
 * @version $Id$
 */
// Call Lunette_Package_WriterTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Lunette_Package_WriterTest::main');
}
...
class Lunette_Package_WriterTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Lunette_Package_WriterTest');
    ...
    {
        $cwd = getcwd();
        $object = new Lunette_Package_Writer();
...
// Call Lunette_Package_WriterTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Lunette_Package_WriterTest::main') {
    Lunette_Package_WriterTest::main();
}
