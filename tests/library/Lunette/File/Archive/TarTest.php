 ...
 */
class Lunette_File_Archive_TarTest extends Lunette_File_Archive_TestCommon
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Lunette_File_Archive_TarTest');
    ...
    {
        $this->object = new Lunette_File_Archive_Tar(dirname(__FILE__) . '/_files/TarTest.tar');
    }
    ...
    {
        $this->setExpectedException('Lunette_File_Archive_Exception', 'File not in archive: foo');
    ...
    public function testExtractList()
    {
        ...
        $sandbox = $this->_getSandboxName();
        $writer = new Lunette_File_Writer($sandbox);
...
// Call Lunette_File_Archive_TarTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Lunette_File_Archive_TarTest::main') {
    Lunette_File_Archive_TarTest::main();
}
