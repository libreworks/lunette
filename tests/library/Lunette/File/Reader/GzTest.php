 ...
 * @version $Id$
 */
// Call Lunette_File_Reader_GzTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Lunette_File_Reader_GzTest::main');
}
require_once dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'TestHelper.php';
require_once 'Lunette/File/Reader/Gz.php';

/**
 * Test class for Lunette_File_Reader_Gz.
 * Generated by PHPUnit on 2008-06-03 at 19:43:10.
 */
class Lunette_File_Reader_GzTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    Lunette_File_Reader_Gz
     */
    protected $object;
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Lunette_File_Reader_GzTest');
    ...
    {
        $this->object = new Lunette_File_Reader_Gz(dirname(__FILE__) . '/_files/example3.txt.gz');
    }
...
// Call Lunette_File_Reader_GzTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Lunette_File_Reader_GzTest::main') {
    Lunette_File_Reader_GzTest::main();
}
